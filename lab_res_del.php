		...
		if($_GET['lab_id']){
			...
			if(mysqli_num_rows($sel_lab_qu) == 1 && mysqli_num_rows($sel_lab_sch) == 1){
				...
				if($_POST){
					...
					$new_lab_sch_qu = "DELETE FROM `labs_sch` WHERE `id` = 45";
					if(mysqli_query($con , $new_lab_sch_qu)){
						?>
<div class="row col-12 justify-content-md-center">
<div class="alert bg-success alert-dismissible mb-2 " role="alert">
	<h5 class="white"><strong>تم !</strong> تم تأكيد حذف المعمل بنجاح</h5>
	</div>
</div>
<script>
	
	setTimeout(function(){
		window.location = "lab_res_del.php?lab_id=<?php echo $lab_id ?>";
	},2000)
...
<?php
	...
	?>
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">تأكيد حذف معمل</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="./lab_res.php?lab_id=<?php echo $lab_id; ?>"><?php echo $run_sel_lab['name']; ?> ( حذف المعمل )</a>
                </li>
                <li class="breadcrumb-item"><a href="#">تأكيد حذف معمل</a>
                </li>
              </ol>
            </div>
          </div>
