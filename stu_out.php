...
if($_POST){
	...
	if(mysqli_num_rows($user_qu) == 1){
		...
		if(mysqli_num_rows($enter_qu) == 0){
		?>
<div class="row col-12 justify-content-md-center">
<div class="alert bg-danger alert-dismissible mb-2" role="alert">
	<h5 class="white"><strong>عفوا !</strong> لقد تم تسجيل دخولك اليوم بالفعل</h5>
	</div>
</div>
...
<div class="alert bg-success alert-dismissible mb-2" role="alert">
	<h5 class="white"><strong>تم !</strong> تم تسجيل الخروج بنجاح</h5>
	</div>
</div>
              ...
              <div class="card border-grey border-lighten-3 m-0">
                ...
                <div class="card-content">
                  ...
                  <div class="card-body pt-0">
                    <form class="form-horizontal" method="post" action="./stu_out.php">
                      <fieldset class="form-group floating-label-form-group">
                        <label for="stu_ac">الرقم الأكاديمي</label>
                        <input type="number" required class="form-control" id="stu_ac" name="stu_ac">
                      </fieldset>
                      <button type="submit" class="btn btn-outline-info btn-block"><i class="ft-unlock"></i> log out</button>
                    </form>
                  </div>
                </div>
              </div>
