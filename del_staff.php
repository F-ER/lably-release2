...
<div class="alert bg-success alert-dismissible mb-2 " role="alert">
	<h5 class="white"><strong>تم !</strong> تم حذف المسؤول بنجاح</h5>
	</div>
</div>
<script>
...
<?php
	...
	?>
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">حذف المسؤول</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="./del_staff.php?tech_id=<?php echo $tech_id; ?>"><?php echo $run_sel_tech['name']; ?> ( حذف المسؤول )</a>
                </li>
                <li class="breadcrumb-item"><a href="#">تأكيد حذف المسؤول</a>
                </li>
              </ol>
            </div>
          </div>
            ...
            <div class="col-md-4">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title font-weight-bold" id="basic-layout-card-center"><?php echo $run_sel_tech['name']; ?> <small>تأكيد حذف المسؤول </small></h4>
                  <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                </div>
                <div class="card-content collapse show px-1">
					 <form class="form" method="post" action="./del_staff.php?tech_id=<?php echo $tech_id; ?>">
                      <div class="form-body">
                        <div class="form-group">
                          <techel for="eventRegInput1">اسم المسؤول </techel>
                        ...
                        <div class="form-group">
                          <techel for="eventRegInput1" class="red text-center full-width">
							  ...
							  <span class="alert-warning p-1 full-width">
								  سيتم حذف جميع الأمور المتعلقة بهذا المسؤول 
							  </span>
							  <br> <br> <br>
							  لحذف الملسؤو يجب كتابة كلمة المرور الخاصه بك
							</techel>
