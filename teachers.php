 <?php
	...
	?>
        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
          <h3 class="content-header-title mb-0 d-inline-block">العلمين</h3>
          <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="./">الرئيسية</a>
                </li>
                <li class="breadcrumb-item"><a href="#">المعلمين</a>
                </li>
              </ol>
            </div>
          </div>
        ...
        <div class="content-header-right col-md-6 col-12">
          <div class="dropdown float-md-right">
            <a href="./new_tech.php"><button class="btn btn-blue btn-glow px-2"  type="button" aria-haspopup="true" aria-expanded="false" >معلم جديد</button></a>
          </div>
        </div>
      </div>
                      ...
                      <h4 class="font-weight-bold">
						  ...
						  <div class="btn-group pull-left">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item blue" href="./edit_tech.php?tech_id=<?php echo $run_sel_techs['id']; ?>"><i class="ft-edit-2"></i> تعديل</a>
                              <a class="dropdown-item red" href="./del_tech.php?tech_id=<?php echo $run_sel_techs['id']; ?>"><i class="ft-trash"></i> حذف</a>
                            </div>
                          </div>
						</h4>
                    </div>
